...
<div class="av-vs-page-block">
	<div class="container">
		<div class="col-lg-7 col-md-7">
			ТОВ "АВ метал груп" - велика і незалежна торгова компанія в Україні. Ми почали свою діяльність на ринку металопрокату у червні 2009 року і через кілька років стали масштабним українським постачальником.
	...
	<div class="container">
		...
		<div class="col-lg-10 col-lg-offset-1">
			<p class="av-vs-page-block-subtitle">
				...
				Ми надаємо вигідні умови співпраці і зацікавлені у надійному і довгостроковому партнерство.
			</p>
		</div>
		<div class="row" >
		...
		<div class="row" >
			<div class="col-lg-3 col-md-3 col-sm-6">
				...
				<div class="av-vs-page-text-sm-block">Наш центр логістики і широкий власний автопарк дозволяють доставити товар клієнту за найкоротші терміни.</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6">
...
<div class="av-vs-page-block">
	<div class="container">
		...
		<div class="av-vs-page-block-subtitle">Компанія "АВ метал груп" бере активну участь у суспільно-громадському житті країни. У першу чергу ми надаємо матеріально-технічну підтримку соціально-незахищеним категоріям населення: утеплюємо дитячі будинки, підтримуємо сім'ї учасників АТО.</div>
	</div>
</div>
