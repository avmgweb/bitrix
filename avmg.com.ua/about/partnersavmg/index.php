...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 av-parthners-page-block first-column">
	...
	<p>Однією з основних завдань компанії АВ метал груп є постійний розвиток дилерської регіональної мережі і залучення нових партнерів.</p>
	<p>Це стає можливим завдяки постійному розширенню філіальної мережі, товарного асортименту металопродукції на складах і розвитку додаткових сервісних послуг. У найкоротші терміни ми доставляємо власним автотранспортом металопрокат в будь-яку точку України.</p>
	<p><a target="_blank" href="/">АВ метал груп</a> максимально відповідає вимогам наших клієнтів. Ми пропонуємо конкурентні ціни, оперативну доставку, інформаційну та технічну підтримку партнерів, гнучку систему знижок, відстрочення платежу і різні пільгові умови для постійних клієнтів.</p>
</div>
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 av-parthners-page-block second-column">
	<h3>Переваги</h3>
	<p>Наш колектив - високопрофесійні і відповідальні менеджери, які постійно відстежують всі тенденції, що відбуваються на ринку металопрокату і пропонують цілий комплекс послуг з передпродажної підготовки, враховуючи всі потреби клієнта.</p>
	<p>Філії АВ метал груп працюють в найбільший містах України: Київ, Дніпро, Львів, Харків, Запоріжжя, Одеса, Миколаїв, Маріуполь, Вінниця, Житомир, Полтава, Кропивницький, Рівне, Суми, Хмельницький, Черкаси, Кам'янське, Мелітополь, Кривий Ріг. Роздрібні металобази розташовані більш ніж в 100 містах по всій території України.</p>
	<p>Швидкість і якість обслуговування - наші пріоритети. Дружна команда нашого колективу - це запорука успіху і просування бізнесу АВ метал груп, на який ми робимо ставку.</p>
</div>
