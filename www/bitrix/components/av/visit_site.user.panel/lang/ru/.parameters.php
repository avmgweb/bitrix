...
// links params
$MESS["AV_AUTH_USER_MENU_TYPE"] = 'Тип меню пользователя';
// registration params
$MESS["AV_AUTH_REGISTRATION_SHOW_FIELDS"]         = 'Поля формы';
$MESS["AV_AUTH_REGISTRATION_SHOW_USER_PROPS"]     = 'Пользовательские поля формы';
$MESS["AV_AUTH_REGISTRATION_REQUIRED_FIELDS"]     = 'Обязательные поля';
$MESS["AV_AUTH_REGISTRATION_REQUIRED_USER_PROPS"] = 'Обязательные пользовательские поля';
// fields titles
