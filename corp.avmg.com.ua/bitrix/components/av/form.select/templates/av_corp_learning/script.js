...
/* -------------------------------------------------------------------- */
SetFormElementsFunction("av_corp_learning", "select", "getFormElememtName",     "getFormElememtNameSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "setFormElememtName",     "setFormElememtNameSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "getFormElememtValue",    "getFormElememtValueSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "setFormElememtValue",    "setFormElememtValueSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "getFormElememtRequired", "getFormElememtRequiredSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "setFormElememtRequired", "setFormElememtRequiredSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "getFormElememtAlert",    "getFormElememtAlertSelectAvCorpLearning");
SetFormElementsFunction("av_corp_learning", "select", "setFormElememtAlert",    "setFormElememtAlertSelectAvCorpLearning");
/* -------------------------------------------------------------------- */
...
$(function()
	{
	SetFormElementsCurrentLibrary("av_corp_learning");
