...
/* -------------------------------------------------------------------- */
SetFormElementsFunction("av_corp", "select", "getFormElememtName",     "getFormElememtNameSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "setFormElememtName",     "setFormElememtNameSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "getFormElememtValue",    "getFormElememtValueSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "setFormElememtValue",    "setFormElememtValueSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "getFormElememtRequired", "getFormElememtRequiredSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "setFormElememtRequired", "setFormElememtRequiredSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "getFormElememtAlert",    "getFormElememtAlertSelectAvCorp");
SetFormElementsFunction("av_corp", "select", "setFormElememtAlert",    "setFormElememtAlertSelectAvCorp");
/* -------------------------------------------------------------------- */
